...
@Service("ActiveCasesCountryWiseCommand")
public class ActiveCasesCountryWiseCommand implements ICommand {
    ...
    private String getValue(byte[] bytes) {
        ...
        assert country != null;
        Long activeCases = country.getTotalConfirmed() - country.getTotalRecovered();
        return country.getCountryCode() + " Active Cases " + activeCases;
    }
}
